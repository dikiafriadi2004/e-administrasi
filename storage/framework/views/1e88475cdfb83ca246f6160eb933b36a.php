    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
        ...
        <div class="space-y-1.5">
            ...
            <input id="email" type="text" name="email"
                   ...
                   class="block w-full rounded-xl border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-brand-400 focus:ring-brand-400 transition-colors <?php $__errorArgs = ['email'];
        ...
        <div class="space-y-1.5">
            <div class="flex items-center justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-brand-600 hover:text-brand-700 hover:underline">
                        Lupa password?
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <input id="password" type="password" name="password"
                   ...
                   placeholder="••••••••"
                   class="block w-full rounded-xl border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-brand-400 focus:ring-brand-400 transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH E:\MUDK Project\project\e-administrasi\resources\views/auth/login.blade.php ENDPATH**/ ?>