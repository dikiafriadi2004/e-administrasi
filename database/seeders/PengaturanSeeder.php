...
class PengaturanSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            // ── Penomoran Surat ───────────────────────────────────────────────
            // Di template Word, tulis tiap bagian sebagai placeholder terpisah:
            //   ${nomor_urut}/${kode_institusi}/${kode_prodi}/${bulan_surat}/${tahun_surat}
            // nomor_urut   = diinput admin saat generate
            // bulan_surat  = otomatis (format: 08)
            // tahun_surat  = otomatis (format: 2026)
            ['key' => 'kode_institusi', 'label' => 'Kode Institusi untuk Nomor Surat (contoh: UN11.F9)',  'grup' => 'penomoran', 'value' => ''],
            ['key' => 'kode_prodi',     'label' => 'Kode Prodi untuk Nomor Surat (contoh: PK.01.06)',     'grup' => 'penomoran', 'value' => ''],

            // ── Konfigurasi Sistem ────────────────────────────────────────────
            ['key' => 'libreoffice_path', 'label' => 'Path LibreOffice (kosong = auto-detect)', 'grup' => 'sistem', 'value' => ''],
        ];
