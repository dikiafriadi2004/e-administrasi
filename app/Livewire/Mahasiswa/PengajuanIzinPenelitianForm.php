...
class PengajuanIzinPenelitianForm extends Component
{
    ...
    /**
     * Surat permohonan / proposal dari instansi (opsional).
     */
    ...
    protected $messages = [
        ...
        'judulPenelitian.required' => 'Judul penelitian wajib diisi.',
        'bidangPenelitian.required' => 'Bidang penelitian wajib diisi.',
    ...
    public function submit(): void
    {
        ...
        if ($this->fileSuratInstansi) {
            ...
            BerkasPengajuan::create([
                ...
                'label' => 'Surat Permohonan dari Instansi',
                'path_file' => $path,
                'nama_asli' => $namaAsli,
            ]);
        }
        ...
        session()->flash('success', 'Pengajuan Surat Izin Penelitian berhasil dikirim. Admin akan segera memproses surat Anda.');
