...
class TemplateSuratController extends Controller
{
    ...
    private function getPlaceholders(string $jenis): array
    {
        ...
        $universal = [
            ...
            // ── Tanggal ───────────────────────────────────────────────────────────────
            '${tanggal_surat}' => ['desc' => 'Tanggal surat (contoh: 25 Agustus 2026)',                    'sumber' => 'Otomatis saat generate'],
        ...
        $spesifik = match ($jenis) {
            ...
            'seminar_proposal' => [
                ...
                '${nama_pembimbing}' => ['desc' => 'Nama dosen pembimbing (alias nama_pembimbing_1)', 'sumber' => 'Data Dosen'],
                '${nip_pembimbing}' => ['desc' => 'NIP dosen pembimbing',                            'sumber' => 'Data Dosen'],
                '${nama_pembimbing_1}' => ['desc' => 'Nama dosen pembimbing (alias nama_pembimbing)', 'sumber' => 'Data Dosen'],
                '${nip_pembimbing_1}' => ['desc' => 'NIP dosen pembimbing 1',                        'sumber' => 'Data Dosen'],
                '${nama_pembimbing_2}' => ['desc' => 'Nama dosen pembimbing 2 (jika ada)',            'sumber' => 'Data Dosen'],
                '${nip_pembimbing_2}' => ['desc' => 'NIP dosen pembimbing 2 (jika ada)',             'sumber' => 'Data Dosen'],
                '${nama_penguji}' => ['desc' => 'Nama dosen penguji I (alias nama_penguji_1)',      'sumber' => 'Data Dosen'],
                '${nip_penguji}' => ['desc' => 'NIP dosen penguji I',                              'sumber' => 'Data Dosen'],
                '${nama_penguji_1}' => ['desc' => 'Nama dosen penguji I',                           'sumber' => 'Data Dosen'],
                '${nip_penguji_1}' => ['desc' => 'NIP dosen penguji I',                            'sumber' => 'Data Dosen'],
                '${nama_penguji_2}' => ['desc' => 'Nama dosen penguji II',                          'sumber' => 'Data Dosen'],
                '${nip_penguji_2}' => ['desc' => 'NIP dosen penguji II',                           'sumber' => 'Data Dosen'],
                '${tanggal_seminar}' => ['desc' => 'Tanggal jadwal seminar (Senin, 25 Agustus 2026)', 'sumber' => 'Ditetapkan Kaprodi'],
                '${waktu_sidang}' => ['desc' => 'Waktu seminar (contoh: 09.00 WIB)',              'sumber' => 'Ditetapkan Kaprodi'],
            ...
            'sidang_skripsi' => [
                ...
                '${nama_penguji_2}' => ['desc' => 'Nama dosen penguji II',                          'sumber' => 'Data Dosen'],
                '${nip_penguji_2}' => ['desc' => 'NIP dosen penguji II',                           'sumber' => 'Data Dosen'],
                '${tanggal_sidang}' => ['desc' => 'Tanggal jadwal sidang (Senin, 25 Agustus 2026)',  'sumber' => 'Ditetapkan Kaprodi'],
                '${waktu_sidang}' => ['desc' => 'Waktu sidang (contoh: 09.00 WIB)',               'sumber' => 'Ditetapkan Kaprodi'],
            ...
            'undangan_penguji' => [
                ...
                '${nip_pembimbing}' => ['desc' => 'NIP dosen pembimbing',                            'sumber' => 'Data Dosen'],
                '${nama_penguji}' => ['desc' => 'Nama dosen penguji yang diundang (alias nama_penguji_1)', 'sumber' => 'Data Dosen'],
                '${nip_penguji}' => ['desc' => 'NIP dosen penguji yang diundang',                  'sumber' => 'Data Dosen'],
                '${nama_penguji_1}' => ['desc' => 'Nama dosen penguji I',                           'sumber' => 'Data Dosen'],
                '${nip_penguji_1}' => ['desc' => 'NIP dosen penguji I',                            'sumber' => 'Data Dosen'],
                '${nama_penguji_2}' => ['desc' => 'Nama dosen penguji II',                          'sumber' => 'Data Dosen'],
                '${nip_penguji_2}' => ['desc' => 'NIP dosen penguji II',                           'sumber' => 'Data Dosen'],
            ...
            'rekomendasi_magang' => [
                '${nama_instansi}' => ['desc' => 'Nama instansi tujuan magang',              'sumber' => 'Diisi mahasiswa'],
                '${alamat_instansi}' => ['desc' => 'Alamat lengkap instansi',                  'sumber' => 'Diisi mahasiswa'],
                '${tanggal_mulai}' => ['desc' => 'Tanggal mulai magang (25 Agustus 2026)',   'sumber' => 'Diisi mahasiswa'],
                '${tanggal_selesai}' => ['desc' => 'Tanggal selesai magang',                   'sumber' => 'Diisi mahasiswa'],
            ],
