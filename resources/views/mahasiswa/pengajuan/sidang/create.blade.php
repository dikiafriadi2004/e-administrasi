<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="rounded-xl border bg-white p-5 shadow-sm">
            <h2 class="mb-4 text-sm font-semibold text-slate-800">Pengajuan Sidang Skripsi</h2>
            ...
            <div class="mb-4 rounded-xl border border-sky-100 bg-sky-50 px-4 py-3 text-xs">
                <div class="flex items-start gap-2">
                    ...
                    <div class="text-sky-800 space-y-1">
                        ...
                        <p>Admin akan memverifikasi kelengkapan berkas, lalu Kaprodi ACC, dan Admin menetapkan jadwal resmi.</p>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('mahasiswa.pengajuan.sidang.store') }}"
                ...
                <div class="flex flex-col gap-2 pt-2">
                    <button type="submit" class="w-full inline-flex items-center justify-center rounded-xl bg-brand-500 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-600 transition-colors">
                        Kirim Pengajuan
                    </button>
