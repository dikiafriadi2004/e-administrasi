    ...
    <div class="flex gap-6 items-start">
        ...
        <div class="w-72 shrink-0">
            <div class="rounded-xl border bg-white p-5 shadow-sm">
                <h2 class="mb-4 text-sm font-semibold text-slate-800">Surat Izin Penelitian</h2>
                ...
                <form wire:submit="submit" class="space-y-4">
                    ...
                    {{-- Judul Penelitian --}}
                    <div>
                        <label for="judulPenelitian" class="block text-xs font-medium text-slate-700 mb-1">
                            Judul Penelitian / Skripsi <span class="text-red-500">*</span>
                        </label>
                        <textarea id="judulPenelitian"
                                  wire:model.blur="judulPenelitian"
                                  rows="2"
                                  placeholder="Contoh: Analisis Pengaruh X terhadap Y"
                                  class="block w-full rounded-xl border-slate-200 text-sm shadow-sm focus:border-brand-400 focus:ring-brand-400"></textarea>
                        @error('judulPenelitian') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                    </div>

                    {{-- Bidang Penelitian --}}
                    <div>
                        <label for="bidangPenelitian" class="block text-xs font-medium text-slate-700 mb-1">
                            Bidang Penelitian <span class="text-red-500">*</span>
                        </label>
                        <input id="bidangPenelitian" type="text"
                               wire:model.blur="bidangPenelitian"
                               placeholder="Contoh: Kesehatan Masyarakat"
                               class="block w-full rounded-xl border-slate-200 text-sm shadow-sm focus:border-brand-400 focus:ring-brand-400" />
                        @error('bidangPenelitian') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        <label for="tanggalSelesai" class="block text-xs font-medium text-slate-700 mb-1">
                            Tanggal Selesai Penelitian <span class="text-red-500">*</span>
                        </label>
