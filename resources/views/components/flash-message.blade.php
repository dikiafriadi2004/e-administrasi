{{-- Toast notification (auto-dismiss 4.5 detik, slide-in dari bawah kanan) --}}
<div
    x-data="{
        notifications: [],
        add(type, message) {
...
>
    ...
    {{-- Session-based flash (server redirect) --}}
    @foreach ([
        ...
        @if ($msg)
            ...
            >
                <span class="mt-0.5 @if($type === 'success') text-emerald-600 @elseif($type === 'error') text-red-500 @elseif($type === 'warning') text-amber-600 @else text-sky-600 @endif">
    ...
    {{-- JS/Livewire dispatch-based notifications --}}
